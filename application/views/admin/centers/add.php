  ...
  <div class="wrapper wrapper-content animated fadeInRight">
    ...
    <div class="ibox ">
      ...
      <div class="ibox-title" >
        ...
        <h5 class"pull-left">اضافة مركز <small></small></h5>
	...
	<div class="form-group">
	  ...
	  <div class="col-sm-4">
	    ...
	    value="<?php echo set_value("center_name"); ?>"
	...
	<div class="form-group">
        ...
        <label class="control-label col-md-3"> اس المالك </label>

          <div class="col-md-4">

              <select class="form-control select2" name="owner" id="owner">

              <option value="">اختر اسم المالك </option>
	...
	<div class="form-group">
      ...
      <!-- Center_city End -->
			...
			<div class="form-group">
			  ...
			  <label for="about_center" class="col-sm-3 control-label"> نبذة عن المركز </label>

			  <div class="col-sm-4">

			    <textarea class="form-control" id="about_center" name="about_center"><?php echo set_value("about_center"); ?></textarea>
	...
	<div class="form-group">
	  ...
	  <label for="center_address" class="col-sm-3 control-label"> العنوان المقر الرئيسي  </label>
	  ...
	  <div class="col-sm-4">
	    ...
	    value="<?php echo set_value("center_address"); ?>"
	...
	<div class="form-group">
	  ...
	  <div class="col-sm-4">
	    ...
	    value="<?php echo set_value("center_branch"); ?>"
	...
	<div class="form-group">
	  ...
	  <div class="col-sm-4">
	    ...
	    value="<?php echo set_value("center_email"); ?>"
	...
	<div class="form-group">
	  ...
	  <div class="col-sm-4">
	    ...
	    value="<?php echo set_value("center_website"); ?>"
	...
	<div class="form-group">
	  ...
	  <div class="col-sm-4">
	    ...
	    value="<?php echo set_value("center_phone"); ?>"
  ...
  <!-- Center_phone End -->
	...
	<div class="form-group">
	  ...
	  <div class="col-sm-4">
	    ...
	    value="<?php echo set_value("center_lat"); ?>"
	...
	<div class="form-group">
	  ...
	  <div class="col-sm-4">
	    ...
	    value="<?php echo set_value("center_long"); ?>"
