...
<div class="form-group">
  ...
  <div class="col-sm-4">
    ...
    value="<?php echo set_value("service_name",html_entity_decode($services->service_name)); ?>"
...
<div class="form-group">
  ...
  <div class="col-sm-4">
    ...
    <textarea class="form-control" id="about_service" name="about_service"><?php echo set_value("about_service",html_entity_decode($services->about_service)); ?></textarea>
...
<div class="form-group">
  ...
  <div class="col-sm-4">
    ...
    value="<?php echo set_value("price",html_entity_decode($services->price)); ?>"
...
<!-- Service_name End -->
	...
	<div class="form-group">
      ...
      foreach($currency as $key => $value): ?>
          ...
          <option value="<?php echo $value->id; ?>" <?php echo $value->id==$services->currency?'selected="selected"':""; ?>>
