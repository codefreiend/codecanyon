...
<div class="row">
  <div class="wrapper wrapper-content animated fadeInRight">
	...
	<div class="form-group">
	  ...
	  <div class="col-sm-4">
	    ...
	    value="<?php echo set_value("country_name"); ?>"
	...
	<div class="form-group">
	  ...
	  <div class="col-sm-4">
	    ...
	    value="<?php echo set_value("country_code"); ?>"
 ...
 <div class="form-group">
          ...
          <div class="col-sm-4">
            ...
            <span style="margin-right:20px;"><input type="radio" style="width:20px; height:20px;" name="country_status" value="Enabled"> Enabled </span>

            <span style="margin-right:20px;"><input type="radio" style="width:20px; height:20px;" name="country_status" value="Disabled"> Disabled </span>
