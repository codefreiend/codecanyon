   ...
   <div class="col-lg-12">
      ...
      <div class="ibox ">
         ...
         <div class="ibox-title">
            ...
            <form method="GET" action="<?php echo base_url().'admin/training_courses/coursesToApproved'; ?>" class="form-inline ibox-content">
         ...
         <div class="table table-responsive">
		   ...
		   <a href="<?php echo base_url()?>admin/training_courses/view/<?php echo $value->id; ?>" title="View">
            ...
            <a href="<?php echo base_url()?>admin/training_courses/approve/<?php echo $value->id; ?>" class="btn btn-success" title="View">

            موافقة 

           </a>

             <a href="<?php echo base_url()?>admin/training_courses/reject/<?php echo $value->id; ?>" class="btn btn-danger" title="View">
