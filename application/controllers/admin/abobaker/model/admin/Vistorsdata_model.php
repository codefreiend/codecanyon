...
class Vistorsdata_model extends CI_Model
{
    public $v_fields=array('name', 'phone', 'email', 'organization', 'job', 'degree.degreeName');
	...
	function getList($table, $pagination=array()) {
        ...
        $this->db->select("$table.*  , degree.degreeName as degree ");
        $this->db->from($table);
         $this->db->join("degree", "vistorsdata.degree = degree.id", "left");     
