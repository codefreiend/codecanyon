...
<div class="form-group">
  ...
  <div class="col-sm-4">
    ...
    value="<?php echo set_value("name",html_entity_decode($vistorsdata->name)); ?>"
...
<div class="form-group">
  ...
  <div class="col-sm-4">
    ...
    value="<?php echo set_value("phone",html_entity_decode($vistorsdata->phone)); ?>"
...
<div class="form-group">
  ...
  <div class="col-sm-4">
    ...
    value="<?php echo set_value("email",html_entity_decode($vistorsdata->email)); ?>"
...
<div class="form-group">
  ...
  <div class="col-sm-4">
    ...
    value="<?php echo set_value("organization",html_entity_decode($vistorsdata->organization)); ?>"
...
<div class="form-group">
  ...
  <div class="col-sm-4">
    ...
    value="<?php echo set_value("job",html_entity_decode($vistorsdata->job)); ?>"
...
<!-- Job End -->
	...
	<div class="form-group">
      ...
      foreach($degree as $key => $value): ?>
          ...
          <option value="<?php echo $value->id; ?>" <?php echo $value->id==$vistorsdata->degree?'selected="selected"':""; ?>>
