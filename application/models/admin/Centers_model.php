...

{
    ...
    public $v_fields=array('center_name', 'specialization.main_specialization', 'logo', 'center_type.type_desc', 'userz.full_name', 'countries.country_name', 'cities.city_name', 'about_center', 'center_address', 'center_branch', 'center_email', 'center_website', 'center_phone', 'center_lat', 'center_long');
	...
	function getList($table, $pagination=array(), $conditions=array()) {
        ...
        $this->db->select("$table.*  , specialization.main_specialization as specialization  , center_type.type_desc as center_type  , userz.full_name as owner  , countries.country_name as center_country  , cities.city_name as center_city ");

        $this->db->from($table);

         $this->db->join("specialization", "centers.specialization = specialization.id", "left");  $this->db->join("center_type", "centers.center_type = center_type.id", "left");  $this->db->join("userz", "centers.owner = userz.id", "left");  $this->db->join("countries", "centers.center_country = countries.id", "left");  $this->db->join("cities", "centers.center_city = cities.id", "left");     
