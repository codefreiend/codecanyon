...

{
    ...
    public $v_fields=array('username', 'password', 'full_name', 'birth_date', 'gender.gender_desc', 'company', 'mobile', 'phone', 'photo', 'countries.name', 'cities.name', 'address');
	...
	function getList($table, $pagination=array()) {
        ...
        $this->db->select("$table.*  , gender.gender_desc as gender  , countries.country_name as country  , cities.city_name as city ");
    ...
    function getStudentsEnvolved($table, $pagination=array(),$course_id) {
    ...
    function getListTable($table) {
      ...
      function getListTableWhere($table, $condition) {
